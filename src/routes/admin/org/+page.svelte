<script lang="ts">
	import OrgRow from './../../../customComponents/OrgRow.svelte';
    ...
    import UniRow from '../../../customComponents/UniRow.svelte';
...
>
    <div class="flex flex-1 overflow-hidden">
        <div class="flex p-4ml-6 mt-8 mb-6 rounded-xl">
            <!-- sidebar -->
            <AdminSidebar active="Organization" refreshToken={refreshToken}/>
        </div>
...
<div class="relative overflow-x-auto">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <OrgRow accessToken={accessToken} org={uni} />
            {/each}
        </tbody>
    </table>
</div>
