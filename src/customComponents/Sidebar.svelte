...
>
    ...
    <a
        ...
        role="button"
        tabindex="0"
        class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all text-[#0b818e] hover:bg-[#0b818e] hover:text-white outline-none dark:hover:bg-slate-100 dark:hover:text-[#1e293b] {active=="Jobs"?"bg-[#0b818e] text-white dark:bg-slate-100 dark:text-black":"dark:text-white"} "    >
        <div class="grid place-items-center mr-4">
    ...
    <a href="/questions"
        role="button"
        tabindex="0"
        class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all text-[#0b818e] hover:bg-[#0b818e] hover:text-white outline-none dark:hover:bg-slate-100 dark:hover:text-[#1e293b] {active=="Questions"?"bg-[#0b818e] text-white dark:bg-slate-100 dark:text-black":"dark:text-white"} "    >
        <div class="grid place-items-center mr-4">
    ...
    <a
        ...
        role="button"
        tabindex="0"
        class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all text-[#0b818e] hover:bg-[#0b818e] hover:text-white outline-none dark:hover:bg-slate-100 dark:hover:text-[#1e293b] {active=="Settings"?"bg-[#0b818e] text-white dark:bg-slate-100 dark:text-black":"dark:text-white"} "    >
        <div class="grid place-items-center mr-4">
            <svg
